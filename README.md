# React_films_API_Redux_Toolkit_Thunk
...
https://OlehKobrynovych.github.io/React_films_API_Redux_Toolkit_Thunk
...
```bash
$ git clone https://github.com/OlehKobrynovych/React_films_API_Redux_Toolkit_Thunk.git
```
